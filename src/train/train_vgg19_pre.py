...
# Argument Parser
# ------------------------
parser = argparse.ArgumentParser(description="Train Pretrained VGG19 on Flavia dataset")
...
# ------------------------
model = build_vgg19_pretrained(num_classes=num_classes, freeze_features=True).to(device)
criterion = nn.CrossEntropyLoss()

# ملاحظة مهمة: لو طبقات features مجمدة → التدريب يكون على classifier فقط
...
for epoch in range(epochs):
    ...
    checkpoint_path = os.path.join(checkpoint_dir, f"vgg19_pretrained_epoch_{epoch+1}.pth")
